...
if (isset($_REQUEST['edit']) && !empty($_REQUEST['edit'])) {
    echo '<input type="hidden" name="update" value="' . sanitize_text_field($_REQUEST['edit']) . '" >';
}
?>   
<script>
                    ...
                    <div  class="panel woocommerce_options_panel" style="display: block;">
                        <div class="options_group" id="rule_tab" style="display: block;">
                            ...
                            woocommerce_wp_select(array(
                                ...
                                'value' => !empty($_REQUEST['rule_on']) ? sanitize_text_field($_REQUEST['rule_on']) : 'products',
                            ...
                            woocommerce_wp_select(array(
                                ...
                                'options' => array('Quantity' => 'Quantity',
                                    'Weight' => 'Weight',
                                    'Price' => 'Price',),
                                'value' => !empty($_REQUEST['check_on']) ? sanitize_text_field($_REQUEST['check_on']) : 'Quantity',
                            ...
                            woocommerce_wp_select(array(
                                ...
                                'value' => !empty($_REQUEST['discount_type']) ? sanitize_text_field($_REQUEST['discount_type']) : 'Percent Discount',
