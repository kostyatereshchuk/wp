        ...
        <tbody style="font-size: smaller;">
            ...
            foreach ($allrules as $key => $value) {
                ...
                foreach ($value as $key2 => $value2) {
                    ...
                    if (($key2 == 'product_id' && empty($value2)) || ($key2 == 'category_id' && empty($value2)) || $key2 == 'adjustment' || $key2 == 'email_ids' || $key2 == 'prev_order_count' || $key2 == 'prev_order_total_amt' || $key2 == 'repeat_rule')
                        continue;
