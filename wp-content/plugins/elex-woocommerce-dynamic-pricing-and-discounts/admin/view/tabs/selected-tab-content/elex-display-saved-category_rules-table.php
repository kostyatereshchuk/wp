        ...
        <tbody style="font-size: smaller;">
            ...
            foreach ($allrules as $key => $value) {
                ...
                foreach ($value as $key2 => $value2) {
                    if ($key2 == 'allow_roles' || $key2 == 'from_date' || $key2 == 'to_date' || $key2 == 'adjustment' || $key2 == 'email_ids' || $key2 == 'prev_order_count' || $key2 == 'prev_order_total_amt')
                        continue;
                    ...
                    if ($key2 == 'category_id') {
                        ...
                        {
                            echo '<span class="highlight">' . elex_dp_get_product_category_by_id($cid) . '</span></br>';
                        }                        
                        echo '</td>';
