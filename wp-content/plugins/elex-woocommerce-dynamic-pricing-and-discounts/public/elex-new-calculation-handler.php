 ...
 * @author Akshay
 */
class Elex_dp_NewCalculationHandler {
...
//            }
     ...
     */
    Public Function elex_dp_getDiscountedPriceForProduct($old_price = '', $product = null, $pid = null) { //error_log($product->get_id()." filter=".current_filter());
    ...
    public function elex_dp_getDiscountedPriceHTML($price, $product) {     // hooked to get_price_html filter
    ...
    public function elex_dp_getDiscountedPriceHTML_for_simple_product($price, $product) {     // hooked to get_price_html filter
        return $price;
    }

    public function elex_dp_getDiscountedPriceHTML_for_group_product($price, $product) {     // hooked to get_price_html filter
    ...
    public function elex_dp_getDiscountedPriceHTML_for_variable_product($price, $product) {     // hooked to get_price_html filter
        $prices=array();
