						...
						'cart-discount' => apply_filters( 'wccs_settings_general_cart_discount_section',
							array(
								'cart_discount_apply_method' => array(
									...
									'std'     => 'first',
									'options' => array(
										'first' => 'Apply first matched rule discount',
										'max'   => 'Apply maximum discount' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'min'   => 'Apply minimum discount' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'sum'   => 'Apply sum of discounts' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
									),
						...
						'checkout-fee' => apply_filters( 'wccs_settings_general_checkout_fee_section',
							array(
								...
								'checkout_fee_apply_method' => array(
									...
									'std'     => 'first',
									'options' => array(
										'first' => 'Apply first matched rule fee' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'max'   => 'Apply maximum fee' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'min'   => 'Apply minimum fee' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'all'   => 'Apply all of fees' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array(
										'first',
										'max',
						...
						'quantity-table' => apply_filters( 'wccs_settings_promotion_quantity_table_section',
							array(
								...
								'quantity_table_layout' => array(
									...
									'options' => array(
										'bulk-pricing-table-horizontal' => 'Horizontal' . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'bulk-pricing-table-vertical'   => 'Vertical',
									),
						...
						'countdown-timer' => apply_filters( 'wccs_settings_promotion_countdown_timer_section',
							array(
								...
								'countdown_timer_title' => array(
									...
									'type' => 'text',
									'std'  => 'Limited-time offer! Sale ends in',
									'readonly' => true,
								),
						...
						'discount-page' => apply_filters( 'wccs_settings_promotion_discount_page_section',
							array(
								...
								'cart_discount_page_message' => array(
									...
									'type' => 'textarea',
									'std'  => 'Visit our [discount_page] to view new discounted products based on your cart.',
									'readonly' => true,
								),
