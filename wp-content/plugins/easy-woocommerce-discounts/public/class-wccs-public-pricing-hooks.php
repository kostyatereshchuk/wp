...
class WCCS_Public_Pricing_Hooks extends WCCS_Public_Controller {
	...
	public function display_bulk_pricing_table() {
		...
		$product_pricing = new WCCS_Public_Product_Pricing( $product, $this->pricing );
	...
	protected function sale_badge_hooks() {
		...
		switch ( $loop_position ) {
			case 'before_shop_loop_item_thumbnail':
				...
				if ( $priority ) {
					$this->loader->add_action( 'woocommerce_before_shop_loop_item_title', $this, 'display_sale_badge', $priority - 1 );
				} else {
					$this->loader->add_action( 'woocommerce_before_shop_loop_item_title', $this, 'display_sale_badge', 9 );
				}
				break;
			...
			case 'after_shop_loop_item_thumbnail':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_before_shop_loop_item_title', $this, 'display_sale_badge', 11 );
				}
				break;
			...
			case 'before_shop_loop_item_title':
				...
				if ( $priority ) {
					$this->loader->add_action( 'woocommerce_shop_loop_item_title', $this, 'display_sale_badge', $priority - 1 );
				} else {
					$this->loader->add_action( 'woocommerce_shop_loop_item_title', $this, 'display_sale_badge', 9 );
				}
				break;
			...
			case 'after_shop_loop_item_title':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_shop_loop_item_title', $this, 'display_sale_badge', 10 );
				}
				break;
			...
			case 'before_shop_loop_item_rating':
				...
				if ( $priority ) {
					$this->loader->add_action( 'woocommerce_after_shop_loop_item_title', $this, 'display_sale_badge', $priority - 1 );
				} else {
					$this->loader->add_action( 'woocommerce_after_shop_loop_item_title', $this, 'display_sale_badge', 4 );
				}
				break;
			...
			case 'after_shop_loop_item_rating':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_after_shop_loop_item_title', $this, 'display_sale_badge', 6 );
				}
				break;
			...
			case 'before_shop_loop_item_price':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_after_shop_loop_item_title', $this, 'display_sale_badge', 9 );
				}
				break;
			...
			case 'after_shop_loop_item_price':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_after_shop_loop_item_title', $this, 'display_sale_badge', 11 );
				}
				break;
		}
		...
		switch ( $single_position ) {
			case 'before_single_item_images':
				...
				if ( $priority ) {
					$this->loader->add_action( 'woocommerce_before_single_product_summary', $this, 'display_sale_badge', $priority - 1 );
				} else {
					$this->loader->add_action( 'woocommerce_before_single_product_summary', $this, 'display_sale_badge', 19 );
				}
				break;
			...
			case 'after_single_item_images':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_before_single_product_summary', $this, 'display_sale_badge', 21 );
				}
				break;
			...
			case 'before_single_item_title':
				...
				if ( $priority ) {
					$this->loader->add_action( 'woocommerce_single_product_summary', $this, 'display_sale_badge', $priority - 1 );
				} else {
					$this->loader->add_action( 'woocommerce_single_product_summary', $this, 'display_sale_badge', 4 );
				}
				break;
			...
			case 'after_single_item_title':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_single_product_summary', $this, 'display_sale_badge', 6 );
				}
				break;
			...
			case 'before_single_item_price':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_single_product_summary', $this, 'display_sale_badge', 9 );
				}
				break;
			...
			case 'after_single_item_price':
				...
				if ( $priority ) {
					...
					$this->loader->add_action( 'woocommerce_single_product_summary', $this, 'display_sale_badge', 11 );
				}
				break;
		}
	}
