			...
			case 'wc-conditions' :
				...
				return array(
					'strings' => array(
						...
						'fee_amount_desc' => sprintf( __( 'Fee amount should be greater than %d.', 'easy-woocommerce-discounts' ), 0 ),
						...
						'pro_buy' => sprintf( __( 'Buy for %1$s', 'easy-woocommerce-discounts' ), '20$' ),
