        ...
        <tr class="berocket_group_is_hide_theme_option_data">
            <th><?php _e('Collapse Button style', 'BeRocket_AJAX_domain'); ?></th>
            <td>
                <div class="berocket_group_is_hide_theme_option_slider">
                    <div>
                        <input type="radio" name="<?php echo $post_name; ?>[group_is_hide_theme]" style="display:none!important;" id="sidebar_collapse_theme_" value="" <?=( empty( $filters['group_is_hide_theme'] ) ? ' checked' : '' )?> />
                    ...
                    foreach ( array(
                        ...
                        'fifth'  => 'Fifth',
                        'sixth'  => 'Sixth',
                    ) as $theme_key => $theme_name ) {
                        ?>
                        <div>
                            <input type="radio" name="<?php echo $post_name; ?>[group_is_hide_theme]" style="display:none!important;"
                                   id="group_is_hide_theme_<?=$theme_key?>" value="<?=$theme_key?>"
                                   <?=( ( ! empty( $filters['group_is_hide_theme'] ) and $filters['group_is_hide_theme'] == $theme_key ) ? ' checked' : '' )?> />
                            <label for="group_is_hide_theme_<?=$theme_key?>"><img src="<?=plugin_dir_url( BeRocket_AJAX_filters_file ) . 'images/themes/sidebar-button/' . $theme_key . '.png'?>" /></label>
                        </div>
                        <?php
                    }
                    ?>
