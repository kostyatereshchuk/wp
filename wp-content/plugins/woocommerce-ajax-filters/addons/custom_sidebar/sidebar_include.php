...
class BeRocket_AAPF_custom_sidebar {
    ...
    public function custom_sidebar_toggle($args = array()) {
        ...
        echo '<a href="#toggle-sidebar" class="berocket_ajax_filters_sidebar_toggle' . $theme_class . '"><span></span>' . $button_text . '</a>';
    }
                    ...
                    <tr class="berocket_group_is_hide_theme_option_data">
                        ...
                        <td>
                            <div class="berocket_group_is_hide_theme_option_slider">';
                                ...
                                foreach ( array(
                                    'first'  => __('First', 'BeRocket_AJAX_domain'),
                                    'second' => __('Second', 'BeRocket_AJAX_domain'),
                                    'third'  => __('Third', 'BeRocket_AJAX_domain'),
                                    'fourth' => __('Fourth', 'BeRocket_AJAX_domain'),
                                    'fifth'  => __('Fifth', 'BeRocket_AJAX_domain'),
                                    'sixth'  => __('Sixth', 'BeRocket_AJAX_domain'),
    ...
    public function wp_footer_sidebar() {
        if ( is_active_sidebar( 'berocket-ajax-filters' ) ) {
            echo "<div id='berocket-ajax-filters-sidebar'>";
